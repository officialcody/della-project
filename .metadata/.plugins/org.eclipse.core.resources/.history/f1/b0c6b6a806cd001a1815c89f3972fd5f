...
public class MemberScreen {
	...
	public MemberScreen(Group mainGroup) {
		...
		removeAffiliation.setLayoutX(365);
		removeAffiliation.setLayoutY(350);
		removeAffiliation.setStyle("-fx-font-weight: bold");

		removeAffiliation1.setLayoutX(365);
		removeAffiliation1.setLayoutY(370);

		removeAffiliation2.setLayoutX(365);
		removeAffiliation2.setLayoutY(390);

		removeAffiliation3.setLayoutX(365);
		removeAffiliation3.setLayoutY(410);
		...
		Affiliation4.setLayoutX(30);
		Affiliation4.setLayoutY(465);
		...
		Affiliation44.setLayoutX(465);
		Affiliation44.setLayoutY(465);
