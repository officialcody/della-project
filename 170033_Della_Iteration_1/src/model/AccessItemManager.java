...
public class AccessItemManager {
	...
	public List<String> establishSortedAccessList3(ActionItem ai, List<ActionItem> aiList) {
		...
		for (ActionItem a : aiList) {
			String i = dateFormat.format(a.getCreatedDate()) + " : " + dateFormat.format(a.getDueDate()) + " : "
					+ a.getActionItemName();
			sortedList3.add(i);
		}
	...
	public List<String> establishSortedAccessList4(ActionItem ai, List<ActionItem> aiList) {
		...
		for (ActionItem a : aiList) {
			String i = dateFormat.format(a.getDueDate()) + " : " + dateFormat.format(a.getCreatedDate()) + " : "
					+ a.getActionItemName();
			sortedList4.add(i);
		}
	...
	public List<String> establishSortedAccessList5(ActionItem ai, List<ActionItem> aiList) {
		...
		for (ActionItem a : aiList) {
			String i = dateFormat.format(a.getDueDate()) + " : " + dateFormat.format(a.getDueDate()) + " : "
					+ a.getActionItemName();
			sortedList5.add(i);
		}
	...
	public List<String> establishSortedAccessList6(ActionItem ai, List<ActionItem> aiList) {
		...
		for (ActionItem a : aiList) {
			String i = dateFormat.format(a.getCreatedDate()) + " : " + dateFormat.format(a.getCreatedDate()) + " : "
					+ a.getActionItemName();
			sortedList6.add(i);
		}
