...
public class ActionItem {
	...
	public void setActionItemName(String x) {
		actionItemName = x;
	}
	...
	public void setResolution(String x) {
		resolution = x;
	}
	...
	public void setDueDate(Date x) {
		dueDate = x;
	}

	public void setCreatedDate(Date x) {
		createdDate = x;
	}
}
