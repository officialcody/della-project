...
public class ActionItemScreen {
	...
	public ActionItemScreen(Group actionItemGroup) {
		...
		actionItemGroup.getChildren().addAll( ActionItems, myComboBox, combolabel,
				...
				sorting, firstsorting, secondsorting, sortcombo,Assigned, firstcombo, secondcombo,Members);
	}
...
datefield.getText());
	...
	private void selectActionItem(ObservableValue<? extends String> ov, String oldValue, String newValue){
		try {
			...
			if(firstcombo.getSelectionModel().getSelectedItem() != null  && secondcombo.getSelectionModel().getSelectedItem() == null || secondcombo.getSelectionModel().getSelectedItem() == "None") {
		...
		else if(firstcombo.getSelectionModel().getSelectedItem() != null && secondcombo.getSelectionModel().getSelectedItem() != null) {
			String[] h =	myComboBox.getSelectionModel().getSelectedItem().toString().split(" : ");
	...
	private void creationdate(ObservableValue<? extends String> observableValue, String oldValue,
			String newValue) {
		String c1= sortcombo.getSelectionModel().getSelectedItem();
		String c2= firstcombo.getSelectionModel().getSelectedItem();
		String c3= secondcombo.getSelectionModel().getSelectedItem();
	...
	private void duedate(ObservableValue<? extends String> observableValue, String oldValue,
			String newValue) {
