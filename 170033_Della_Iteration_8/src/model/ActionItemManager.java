...
public class ActionItemManager {
	...
	public ActionItem updateActionItem(String name, String Member, String description, String resolution, String status,
		...
		// being wasteful now.
		ActionItem ai = new ActionItem(name, Member, description, resolution, status);
	...
	public ActionItem createActionItem(String name, String Member, String description, String resolution, String status,
			String dueDateStr) throws Exception {
		ActionItem ai = new ActionItem(name, Member, description, resolution, status);
	...
	public List<String> getActionItemMembername(ActionItem ai) {
		List<String> namesList = new ArrayList<>();
		namesList = aiM.establishSortedAccessList1(ai, ailist);
		return namesList;
	}

	public List<String> getActionItemmembercreate(ActionItem ai) {
		List<String> namesList = new ArrayList<>();
		namesList = aiM.establishSortedAccessList2(ai, ailist);
		return namesList;
	}

	public List<String> getActionItemmemberdue(ActionItem ai) {
		List<String> namesList = new ArrayList<>();
